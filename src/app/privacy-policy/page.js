        ...
        <link rel="canonical" href="https://socialprachar.com/privacy-policy" />
            ...
            <div className={style.bg_light}>
                <div className={style.Page}>
                    ...
                    <hr />
                    <h1 className='fw-bold mb-4'>Data Protection Guidelines</h1>
                    ...
                    <h1 className='fw-bold mb-4'>Interpretation and Definitions</h1>
                    <h2 className='fw-bold mb-4'>Interpretation</h2>
                    ...
                    <ul>
                        <li className='mb-4'><strong>Account </strong> menas a unique account created for You to access our Service or parts of our Service.</li>
                        <li className='mb-4'><strong>Affiliate </strong> means an entity that controls, is controlled by, or is under common control with a party, where “control” means ownership of 50% or more of the shares, equity interest, or other securities entitled to vote for the election of directors or other managing authority.</li>
                        <li className='mb-4'><strong>Company </strong> refers to SocialPrachar, 508, Manjeera Majestic Commercial, Kphb, Hyderabad.</li>
                        <li className='mb-4'><strong>Cookies </strong> are small files placed on Your computer, mobile device, or any other device by a website containing browsing history details.</li>
                        <li className='mb-4'><strong>Country </strong> refers to: Telangana, India.</li>
                        <li className='mb-4'><strong>Device </strong> means any device that can access the Service such as a computer, cellphone, or tablet.</li>
                        <li className='mb-4'><strong>Personal Data </strong> is any information relating to an identified or identifiable individual.</li>
                        <li className='mb-4'><strong>Service </strong> refers to the Website.</li>
                        <li className='mb-4'><strong>Service Provider </strong> means any person who processes data on behalf of the Company.</li>
                        <li className='mb-4'><strong>Usage Data </strong> refers to data collected automatically during use of the Service.</li>
                        <li className='mb-4'><strong>Website </strong> refers to Social Prachar, accessible from <a href="https://socialprachar.com/">https://socialprachar.com/</a>.</li>
                        <li className='mb-4'><strong>You </strong> means the individual accessing or using the Service, or the legal entity on behalf of which the individual is accessing or using the Service.</li>
                    </ul>


                    <h1 className='fw-bold mb-4'>Collecting and Using Your Personal Data</h1>
                    <h2 className='fw-bold mb-4'>Types of Data Collected</h2>
                    ...
                    <ul className={style.custom_list}>
                        ...
                        <li className='mb-4'>First name and last name</li>
                        <li className='mb-4'>Phone number</li>
                        <li className='mb-4'>Usage Data</li>
                    </ul>

                    <h3 className='fw-bold mb-4'>Usage Data</h3>
                  ...
                  <p>Usage Data may include information such as Your Device&rsquo;s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>
                    ...
                    <h3 className='fw-bold mb-4'>Tracking Technologies and Cookies</h3>
                    ...
                    <p className='fw-bold mb-4'>Necessary / Essential Cookies</p>
                    <ul>
                    ...
                    <p className='fw-bold mb-4'>Cookies Policy / Notice Acceptance Cookies</p>
                    <ul>
                        <li className='mb-4'><strong>Type:</strong> Persistent Cookies</li>
                        <li className='mb-4'><strong>Administered by:</strong> Us</li>
                        <li className='mb-4'><strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the Website.</li>
                    </ul>

                    <p className='fw-bold mb-4'>Functionality Cookies</p>
                    <ul>
                        <li className='mb-4'><strong>Type:</strong> Persistent Cookies</li>
                        <li className='mb-4'><strong>Administered by:</strong> Us</li>
                    ...
                    <p>For more information about the cookies we use and your choices regarding cookies, please visit our <a href="cookies-policy.html">Cookies Policy</a> or the Cookies section of our <a href="privacy-policy.html">Privacy Policy</a>.</p>
                    ...
                    <h2 className='fw-bold'>Retention of Your Personal Data</h2>
                    ...
                    <h2 className='fw-bold'>Transfer of Your Personal Data</h2>
                  <p>Your information, including Personal Data, is processed at the Company&rsquo;s operating offices and in any other places where the parties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
                    ...
                    <h2 className='fw-bold'>Delete Your Personal Data</h2>
                    ...
                    <h2 className='fw-bold'>Disclosure of Your Personal Data</h2>
                    <p>The Company may disclose Your Personal Data in situations such as business transactions, law enforcement requests, or when required by law.</p>

                    <h4 className='fw-bold'>Business Transactions</h4>
                    <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

                    <h4 className='fw-bold'>Law enforcement</h4>
                    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

                    <h4 className='fw-bold'>Other legal requirements</h4>
                    ...
                    <h2 className='fw-bold'>Security of Your Personal Data</h2>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                   

                  <h1 className='fw-bold'>Children&rsquo;s Privacy</h1>
                  ...
                  <p>If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent&rsquo;s consent before We collect and use that information.</p>
                    ...
                    <h1 className='fw-bold'>Links to Other Websites</h1>
                  <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&rsquo;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                    ...
                    <h1 className='fw-bold'>Changes to this Privacy Policy</h1>
