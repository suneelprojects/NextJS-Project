...
import background from "@/assets/courses/courseDetailspage/background.png";
    ...
    <>
      ...
      >
        <div className={styles.timelineHeading}>
          {card ? (
            <p>
              Your Path to Becoming a Job-Ready{" "}
              <span style={{ color: "#ff5003" }}>{card.timeLineHeading}</span>{" "}
              Starts Here!
            </p>
          ) : (
            <p>Loading...</p>
        ...
        <div className={styles.courseLevel}>
          ...
          {card &&
            card.levelcardIndex &&
            card.levelcardIndex.map((level, index) => (
              <div
                key={index}
