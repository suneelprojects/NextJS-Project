...
const studentPlan = [
    ...
    {
        title: <>Standard Pack - <span style={{ color: '#ff5003' }}>₹24,999/- </span></>,
        subTitle: [
    ...
    {
        title: <>premium Plan - <span style={{ color: '#ff5003' }}>₹44,999/- </span></>,
        subTitle: [
            "100% Online Learning with 1-Year App Access",
            ...
            <div className="container py-5">
                <div className="row g-4 justify-content-center">
                    ...
                    <h2 className="fw-bold text-center">
                        <FaBookOpen className="me-2 d-inline" fontSize={50} /> Choose Your Perfect Learning Plan
                    </h2>
