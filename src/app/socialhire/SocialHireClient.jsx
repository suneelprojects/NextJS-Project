...
import socialhireLogo from '@/assets/more/socialHire/Social Hire Logo.png';
import headerImage from '@/assets/more/socialHire/Job Ready Courses.png';
import Image from 'next/image';

export default function SocialHireClient() {
  const handleRedirect = () => {
    window.open('https://socialhire.in', '_blank');
  };

  const ourOffersArray = [
    {
      offerTitle: "1. Job-Ready Courses:",
      offerContent: "Comprehensive programs designed to align with industry demands. Focus on in-demand skills like Full Stack, Data Science, AI, Cloud Computing, and Digital Marketing."
    },
    {
      offerTitle: "2. Career Workshops:",
      offerContent: "Expert-led workshops to guide you in navigating your career path. Gain insights into the latest trends and strategies for career growth."
    },
    {
      offerTitle: "3. Curated Jobs Platform:",
      offerContent: "Handpicked job opportunities tailored to your skillset. A seamless platform to apply for jobs and get hired."
    },
    {
      offerTitle: "4. AI-Powered Resume Builder:",
      offerContent: "Create professional and ATS-friendly resumes effortlessly. Stand out to recruiters with optimized and polished resumes."
    },
    {
      offerTitle: "5. Guaranteed Jobs:",
      offerContent: "Secure job placements with packages ranging from 3 to 12 LPA. A proven track record of 95% placement success."
    },
    {
      offerTitle: "6. AI-Powered Assessment Tools:",
      offerContent: "Tools to track and improve your performance. Mock interviews and tests to prepare you for the real world."
    }
  ];
    ...
    <>
      <div>
        <div className={`container ${styles.imageContainer}`}>
          <Image className='container' src={headerImage} alt="header img" />
        </div>
      </div>
      <div className="container py-5">
        <div className="text-center mb-5">
          <h1 className="display-4 text-primary fs-5">
            <Image className={styles.image} src={spLogo} alt="spLogo" />
            <span className='fw-bold fs-1 pe-3 text-center'>+</span>
            <Image className={styles.image} src={socialhireLogo} alt="SH_Logo" />
