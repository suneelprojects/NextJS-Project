              ...
              <div className="row justify-content-center">
                <div className="col-12 col-md-10 text-center">
                  <h1 className={styles.heroOverlayTitle}>
                    Build a High-Growth Career in Full Stack Development{' '}
                  ...
                  <p className={styles.heroOverlaySubtitle}>
                    Discover how you can launch a powerful tech career in Full
                    Stack Development using MERN, Java, or Python — with
                    practical skills, real-world projects, and job-ready
                    confidence.
                  </p>
                  <p className={styles.heroOverlaySubtitle}>
                    ...
                    , an IIM alumnus and industry mentor with 12+ years of
                    experience in tech training and career transformation. – an
                    industry expert with 8+ years of experience!
                  </p>
                  <p className={styles.heroOverlayNote}>
                    Discover how you can build a rewarding{' '}
                    <span className={styles.mentorName}> Full Stack career </span>{' '}
        ...
        <div className="container">
          ...
          <div className={styles.discoverList}>
            {[
              ...
              <div key={index} className={styles.discoverItem}>
                {item}
              </div>
            ))}
          </div>
