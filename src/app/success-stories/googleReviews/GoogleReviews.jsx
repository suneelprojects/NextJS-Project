...
import GoogleStyle from './GoogleReviews.module.css';
import googleLogo from '@/assets/successStories/google.png';
  ...
  return (
    <>
      <div className={GoogleStyle.google}>
        <p
          className={`${GoogleStyle.header} text-center d-flex align-items-center justify-content-center`}
        >
          Google
        ...
        >
          <div className="row flex-row flex-nowrap pt-3 align-items-stretch">
            {googleReviewsData.map((data) => (
              <div
                key={data.id}
                className="col-3 col-sm-4 col-lg-4 col-xl-4 d-flex"
              >
                <div
                  className={`${GoogleStyle.googleCard} card h-100 d-flex flex-column`}
                >
                  ...
                  >
                    <Image
                      src={
                        data.commentPerson.profileImage ||
                        "path-to-default-image"
                      }
                      alt="Profile"
                      className={`${GoogleStyle.profileImage} rounded-circle mb-2`}
                    />
                    <p className={`mb-1 fw-bold ${GoogleStyle.name}`}>
